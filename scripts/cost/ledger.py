...
def main() -> int:
    parser = argparse.ArgumentParser(description="Append an intent-based MCP routing decision to the Ralph routing ledger.")
    ...
    decision = route_task(args.task_type, args.complexity, args.sensitivity, text=args.text, intent=args.intent)
