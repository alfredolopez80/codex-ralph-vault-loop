...
by the trusted local sensitive-content classifier. Redactable matches are
replaced locally before the engine is invoked; an unredactable or still-`RED`
result blocks reviewer execution.
