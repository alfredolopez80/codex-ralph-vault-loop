...
3. Apply responsive standalone HTML guidance directly: keep the file self-contained, avoid external libraries, and use inline SVG/CSS rather than CDN-loaded charting or diagram packages.
