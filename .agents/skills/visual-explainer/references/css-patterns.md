...
Use these patterns only for user-provided, approved local, or otherwise already-available images. This sanitized Codex install must not call external image generators from this skill.
