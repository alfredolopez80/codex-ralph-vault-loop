...
def test_sensitive_detector_allows_runtime_generated_database_urls() -> None:
    ...
    samples = [
        ...
        url_prefix + "$" + pw_name + "@postgres/control_api",
        url_prefix + "$(openssl rand -hex 32)@postgres/control_api",
    ]
...
def test_sensitive_detector_blocks_literal_database_url_passwords() -> None:
    scheme = "postgres" + "ql"
    sample = scheme + "://control_api_runtime:hunter2@postgres/control_api"
