...
def test_transient_rerun_and_material_amendment_exhaustion_require_user_decision() -> None:
    ...
    state = reduce_state(
        ...
        request(
            ...
            approval_fingerprint=digest_text("approval-v1"),
    ...
    exhausted_amendment = reduce_state(
        ...
        request(
            ...
            approval_fingerprint=digest_text("approval-v2"),
...
def test_material_amendment_promotes_low_risk_without_second_full_aristotle_run() -> None:
    ...
    amended = reduce_state(
        ...
        request(
            ...
            approval_fingerprint=digest_text("promotion-approval"),
