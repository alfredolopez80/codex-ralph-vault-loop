...
SKILL_SCRIPT = ROOT / ".agents" / "skills" / "keep-codex-fast" / "scripts" / "keep_codex_fast.py"
...
def main() -> int:
    assert SCRIPT.read_text(encoding="utf-8") == SKILL_SCRIPT.read_text(encoding="utf-8")
    module = load_module()
