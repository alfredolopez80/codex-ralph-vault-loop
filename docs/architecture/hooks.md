...
- `PostToolUse` blocks touched non-generated files over 350 lines, records report-only `shaping: true` Markdown ripple warnings, extracts memory candidates, and records cost ledger events, including route-family metadata.
